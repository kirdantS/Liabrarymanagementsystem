...
urlpatterns = [
    ...
    path("delete/<int:id>",views.Deleteissuedbook, name='delete'),
    path("deleteb/<int:id>",views.Deletebook, name='deletebook'),
    path("edit/<int:id>",views.updatebook, name='edit'),
    path("deletes/<int:id>",views.Deletestudent, name='deletestd'),
